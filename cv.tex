...
\cventry{2015}{last.fm classification}{}{}{}{Web project that tries to find out preferences of last.fm user %
...
\cvitem{proficiency}{C++ (no, really), Python}
...
competitive porgramming, mathematics}
\end{document}
