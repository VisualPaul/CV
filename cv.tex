...
\begin{document}
\makecvtitle
\emph{Winner of competitive programming contests with mathematical skills looking for internship}
\section{Interests}
\cvitem{}{computer science(machine learning, algorithms), \newline{}competitive porgramming, mathematics}

\section{Education}
\cventry{2014--2018}{BS CS, minor economics}{NRU Higher School of Economics}{Moscow}{}{}
...
Keywords: C\#, mobile, Windows Phone, asynchronious, REST}
\cventry{2014}{xv6}{}{}{}{A study project - some modifications to the kernel of a toy operating system.\newline{}
...
Keywords: classification, machine learning, Python, Jinja2, Web, Google App engine, Beaker cache, REST, Asynchronious\newline{}
